...
\chapter{First evaluation\label{chap:first-eval}}
\input{eval1.tex}

\chapter{GEA: second prototype\label{chap:second-prot}}
\input{secondprot.tex}

\chapter{Second evaluation\label{chap:second-eval}}
\input{eval2.tex}
...
\chapter{Second appendix - Questionnaire\label{app:second-appendix}}
